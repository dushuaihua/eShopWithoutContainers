...
public class CatalogScenariosBase
{
    public TestServer CreateServer()
    {
        ...
        testServer.Host.MigrateDbContext<CatalogContext>((context, services) =>
        {
    ...
    public static class Get
    {
        ...
        {
            return paginated ? "api/v1/catalog/items" + Paginated(PageIndex, PageCount) : "api/v1/catalog/items";
        }
        ...
        {
            return paginated ? $"/api/v1/catalog/items/withname/{name}" + Paginated(PageIndex, PageCount) : $"api/v1/catalog/items/withname/{name}";
        }
