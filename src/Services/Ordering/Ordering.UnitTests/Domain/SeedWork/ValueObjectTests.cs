...
public class ValueObjectTests
{
    ...
    static Guid GUID = new Guid("97ea43f0-6fef-4fb7-8c67-9114a7ff6ec0");
    private static readonly ValueObject APrettyValueObject = new ValueObjectA(1, "2", GUID, new ComplexObject(2, "3"));
    public static readonly TheoryData<ValueObject, ValueObject, string> EqualValueObjects = new TheoryData<ValueObject, ValueObject, string>
    {
        ...
        {
            new ValueObjectA(1, "2", GUID, new ComplexObject(2, "3")),
            new ValueObjectA(1, "2", GUID, new ComplexObject(2, "3")),
            "they should be equal because they have equal members"
        },
        {
            new ValueObjectA(1, "2", GUID, new ComplexObject(2, "3"), notAnEqualityComponent: "xpto"),
            new ValueObjectA(1, "2", GUID, new ComplexObject(2, "3"), notAnEqualityComponent: "xpto2"),
    ...
    {
        {
            new ValueObjectA(a: 1, b: "2", c: GUID, d: new ComplexObject(2, "3")),
            new ValueObjectA(a: 2, b: "2", c: GUID, d: new ComplexObject(2, "3")),
            "they should not be equal because the 'A' member on ValueObjectA is different among them"
        },
        {
            new ValueObjectA(a: 1, b: "2", c:  GUID, d: new ComplexObject(2, "3")),
            new ValueObjectA(a: 1, b: null, c: GUID, d: new ComplexObject(2, "3")),
            "they should not be equal because the 'B' member on ValueObjectA is different among them"
        },
        {
            new ValueObjectA(a: 1, b: "2", c: GUID, d: new ComplexObject(a: 2, b: "3")),
            new ValueObjectA(a: 1, b: "2", c: GUID, d: new ComplexObject(a: 3, b: "3")),
