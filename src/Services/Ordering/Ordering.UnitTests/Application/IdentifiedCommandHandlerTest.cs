...
public class IdentifiedCommandHandlerTest
{
    ...
    public async Task Handler_sends_command_when_order_no_exists()
    {
        ...
        _mediator.Setup(x => x.Send(It.IsAny<IRequest<bool>>(), default(CancellationToken))).Returns(Task.FromResult(true));
        ...
        Assert.True(result);
        _mediator.Verify(x => x.Send(It.IsAny<IRequest<bool>>(), default(CancellationToken)), Times.Once());
    }
