...
public class BasketService : Basket.BasketBase
{
    ...
    public override async Task<CustomerBasketResponse> GetBasketById(BasketRequest request, ServerCallContext context)
    {
        ...
        {
            context.Status = new Status(StatusCode.OK, $"Basket with id {request.Id} do not exist");
        }
    ...
    {
        _logger.LogInformation("Begin grpc call BasketService.UpdateBasketAsync from buyer id {Buyerid}", request.Buyerid);
