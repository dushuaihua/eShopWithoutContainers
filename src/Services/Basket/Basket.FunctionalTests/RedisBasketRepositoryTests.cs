...
public class RedisBasketRepositoryTests : BasketScenarioBase
{
    ...
    RedisBasketRepository BuildBasketRepository(ConnectionMultiplexer connectionMultiplexer)
    {
        var loggerFactory = new LoggerFactory();
        return new RedisBasketRepository(loggerFactory, connectionMultiplexer);
    }
